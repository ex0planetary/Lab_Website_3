...
app.get('/team_stats', function(req, res) {
	var query1 = "SELECT visitor_name, home_score, visitor_score, players, to_char(game_date, 'MM/DD/YYYY') AS game_date_text FROM football_games;";
